...
<td>
<button class='btn btn-danger' onclick="deleteMobile(${item.id
      })">Delete</button>
<button class='btn btn-success nl-3' data-toggle="modal" data-target = "#exampleModal" onclick="editMobile(${item.id
      })"> Edit </button>
</td>
</tr>
`;
